															...
															<td data-label="@lang('Shipping State')">
																<a href="{{ route('operatorCountryShowRate', ['state-list', $stateList->parcel_type_id]) }}"
																   class="text-decoration-underline">
																	<span class="badge badge-light">{{ $stateList->getTotalState($stateList->parcel_type_id) }}</span>
																</a>
															</td>
													...
													@empty
														<tr>
															<td colspan="100%" class="text-center p-2">
																...
																<p class="text-center no-data-found-text">@lang('No Shipping Rates data')</p>
															</td>
														</tr>
													@endforelse
