...
@section('page_title')
	@lang(optional(basicControl()->operatorCountry)->name.' State Rate List')
@endsection
	...
	<div class="main-content">
		<section class="section">
			<div class="section-header">
				<h1>@lang('State Rate List') (@lang(optional(basicControl()->operatorCountry)->name))</h1>
				<div class="section-header-breadcrumb">
					<div class="breadcrumb-item active">
						<a href="{{ route('admin.home') }}">@lang('Dashboard')</a>
					</div>
					<div class="breadcrumb-item">@lang('State Rate List')</div>
				</div>
			</div>
							...
							<div class="row justify-content-md-center">
								<div class="col-lg-12">
									<div class="card mb-4 card-primary shadow">
										<div
											class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
											<h6 class="m-0 font-weight-bold text-primary">@lang('State Rate')</h6>
																...
																<td data-label="@lang('Action')">
																	...
																	@if(adminAccessRoute(config('permissionList.Shipping_Rates.Operator_Country_Rate.permission.delete')))
																		<button data-target="#deleteStateRateModal"
																				...
																				class="btn btn-sm btn-outline-danger rounded-circle deleteStateRate">
				...
				<form action="" method="post" id="editStateRateForm">
					...
					<div class="modal-body">
						...
						<div class="col-12 mt-3">
							<label for="">@lang('From State')</label>
							<select name="from_state_id"
									class="form-control @error('from_state_id') is-invalid @enderror fromState">
						...
						<div class="col-12 mt-3">
							<label for="">@lang('To State')</label>
							<select name="to_state_id"
									class="form-control @error('to_state_id') is-invalid @enderror toState">
								<option value="" selected disabled>@lang('Select State')</option>
								@foreach(optional(basicControl()->operatorCountry)->state() as $state)
									<option value="{{ $state->id }}">@lang($state->name)</option>
								@endforeach
