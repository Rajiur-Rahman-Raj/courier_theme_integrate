							...
							<div class="card-body">
								<form action="{{ route('admin.auth.login') }}" method="post" class="needs-validation" novalidate="">
									...
									<div class="form-group">
										...
										<input id="email" type="text" class="form-control @error('username') is-invalid @enderror @error('email') is-invalid @enderror" name="identity" value="admin" placeholder="@lang('Enter Email or Username')" tabindex="1" autofocus>
									...
									<div class="form-group">
										...
										<input id="password" type="password" class="form-control @error('password') is-invalid @enderror" placeholder="@lang('Enter Password')" name="password" value="admin" tabindex="2" required>
										<div class="invalid-feedback">
									...
									@if(basicControl()->manual_reCaptcha_status == 1 && basicControl()->reCaptcha_status_admin_login)
