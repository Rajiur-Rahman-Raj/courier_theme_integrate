	...
	<div class="main-content">
		<section class="section">
			<div class="section-header">
				<h1>@lang("Create Driver")</h1>
				<div class="section-header-breadcrumb">
					<div class="breadcrumb-item active"><a href="{{ route('admin.home') }}">@lang("Dashboard")</a></div>
					<div class="breadcrumb-item"><a
							href="{{route('branchDriverList')}}">@lang("Branch Driver List")</a></div>
					<div class="breadcrumb-item">@lang("Create Driver")</div>
				</div>
			</div>
		</section>
			...
			<div class="row">
				<div class="col-12 col-md-12 col-lg-12">
					<div class="card mb-4 card-primary shadow-sm">
						...
						<div class="card-body">
							<form method="post" action="{{ route('branchDriverStore') }}"
								...
								<div class="row mb-3">
									<div class="col-sm-12 col-md-12 mb-3">
										...
										<select name="branch_driver_id"
												class="form-control @error('branch_driver_id') is-invalid @enderror select2 branchDriver"
												id="branchDriver">
								...
								<div class="row">
									<div class="col-sm-12 col-md-12 mb-3">
										<label for="national_id"> @lang('National Id') <span
												class="font-weight-bold"><span class="font-weight-bold"><sub>(@lang('optional'))</sub></span></span></label>
