<form method="post" action="{{ route('shipmentStore', 'internationally') }}"
	...
	<div class="row">
		...
		<div class="col-sm-12 col-md-3 mb-3">
			...
			<select name="from_state_id" class="form-control @error('from_state_id') is-invalid @enderror select2 select2State selectedFromState" data-oldfromstateid="{{ old('from_state_id') }}">
			</select>
			<div class="invalid-feedback">
		...
		<div class="col-sm-12 col-md-3 mb-3">
			<label for="from_city_id">@lang('Select City') <span
					class="text-dark font-weight-bold">(@lang('optional'))</span></label>
			<select name="from_city_id" class="form-control @error('from_city_id') is-invalid @enderror select2 select2City selectedFromCity" data-oldfromcityid="{{ old('from_city_id') }}">
			</select>
			<div class="invalid-feedback">
		...
		<div class="col-sm-12 col-md-3 mb-3">
			<label for="to_state_id">@lang('Select State') <span
					class="text-dark font-weight-bold">(@lang('optional'))</span></label>
			<select name="to_state_id" class="form-control @error('to_state_id') is-invalid @enderror select2 select2State selectedToState" data-oldtostateid="{{ old('to_state_id') }}">
			</select>
			<div class="invalid-feedback">
