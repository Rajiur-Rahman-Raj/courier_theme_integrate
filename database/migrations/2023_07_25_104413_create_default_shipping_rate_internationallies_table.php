...
class CreateDefaultShippingRateInternationalliesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('default_shipping_rate_internationallies', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('default_shipping_rate_internationallies');
    }
}
