													...
													<div class="row">
															...
															<div class="form-group">
																...
																<select name="short_name"
																	...
																	@foreach(config('languages.langCodeWithoutFlag') as $key => $value)
																		<option
																			value="{{$key}}" {{  (old('short_name') == $key ? ' selected' : '') }}>{{ __($key).' - '.__($value) }}</option>
																	@endforeach
																</select>
																<div
																	class="invalid-feedback">@error('short_name') @lang($message)@enderror
																</div>
															</div>
														</div>
														<div class="col-md-6">
														...
														<div class="col-md-6">
															<div class="form-group mb-4">
																...
																<div id="image-preview" class="image-preview" style="background-image: url({{ getFile(config('location.language.path'))}});">
