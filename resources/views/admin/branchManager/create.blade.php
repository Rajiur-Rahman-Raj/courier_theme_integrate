	...
	<div class="main-content">
		<section class="section">
			<div class="section-header">
				<h1>@lang("Create Manager")</h1>
				<div class="section-header-breadcrumb">
					<div class="breadcrumb-item active"><a href="{{ route('admin.home') }}">@lang("Dashboard")</a></div>
					<div class="breadcrumb-item"><a href="{{route('branchManagerList')}}">@lang("Managers")</a></div>
					<div class="breadcrumb-item">@lang("Create Manager")</div>
				</div>
			</div>
		</section>
								...
								<div class="row">
									<div class="col-sm-12 col-md-3">
										<div class="form-group mb-4">
											<label class="col-form-label font-weight-normal">@lang("Manager Photo")</label>
