													...
													<div class="row">
															...
															<div class="form-group">
																...
																<select name="short_name"
																	...
																	@foreach(config('languages.langCodeWithoutFlag') as $key => $value)
																		<option
																			value="{{$key}}" {{ (old('short_name', strtolower($language->short_name)) == $key ? ' selected' : '') }}>{{ __($key).' - '.__($value) }}</option>
																	@endforeach
																</select>
																<div
														...
														<div class="col-md-4">
															<div class="form-group">
																...
																<div class="selectgroup w-100">
																	<label class="selectgroup-item">
																		<input type="radio" name="default_status" value="0"
																			   class="selectgroup-input" {{ (old('default_status', $language->default_status) == 0 ? ' checked' : '') }}>
																		<span
																			class="selectgroup-button">@lang('OFF')</span>
																	</label>
																	<label class="selectgroup-item">
																		<input type="radio" name="default_status" value="1"
																			   class="selectgroup-input" {{ (old('default_status', $language->default_status) == 1 ? ' checked' : '') }}>
																		<span
																			class="selectgroup-button">@lang('ON')</span>
																	</label>
																</div>
														...
														<div class="col-md-12">
															<div class="form-group mb-4">
																...
																<div id="image-preview" class="image-preview"
																	 style="background-image: url({{ getFile($language->driver,$language->flag) ? : 0 }});">
