		...
		<div class="col-sm-12 col-md-12 mb-3">
			...
			<div class="custom-control custom-radio">
				<input type="radio" id="shipmentTypeCondition"
					   ...
					   value="condition"
					   class="custom-control-input"
					   @if(old('shipment_type', $singleShipment->shipment_type) === 'condition') checked @endif>
				<label class="custom-control-label"
		...
		<div class="col-sm-12 col-md-3 mb-3">
			...
			<div class="input-group">
				<input type="text" class="form-control"
					   name="receive_amount"
					   value="{{ old('receive_amount', $singleShipment->receive_amount) }}"
					   placeholder="0.00"
	...
	<div class="row">
		...
		<div class="col-sm-12 col-md-3 mb-3">
			...
			<select name="receiver_id"
				...
				@foreach($receivers as $receiver)
					<option
						value="{{ $receiver->id }}" {{ old('receiver_id', $singleShipment->receiver_id) == $receiver->id ? 'selected' : ''}}>@lang($receiver->name)
						({{ $receiver->username }})
					</option>
				@endforeach
			</select>
		...
		<div class="col-sm-12 col-md-3 mb-3">
			...
			<select name="from_state_id"
				...
				@foreach(optional($basicControl->operatorCountry)->state() as $state)
					<option
						value="{{ $state->id }}" {{ old('from_state_id', $singleShipment->from_state_id) == $state->id ? 'selected' : ''}}>@lang($state->name)</option>
				@endforeach
			</select>
			<div class="invalid-feedback">
		...
		<div class="col-sm-12 col-md-3 mb-3">
			...
			<select name="from_city_id"
					...
					data-fromcityid="{{ $singleShipment->from_city_id }}">
			</select>
			<div class="invalid-feedback">
		...
		<div class="col-sm-12 col-md-3 mb-3">
			...
			<select name="to_state_id"
				...
				@foreach(optional($basicControl->operatorCountry)->state() as $state)
					<option
						value="{{ $state->id }}" {{ old('to_state_id', $singleShipment->to_state_id) == $state->id ? 'selected' : ''}}>@lang($state->name)</option>
				@endforeach
			</select>
			<div class="invalid-feedback">
		...
		<div class="col-sm-12 col-md-3 mb-3">
			...
			<select name="to_city_id"
					...
					data-oldtocityid="{{ old('to_city_id') }}" data-tocityid="{{ $singleShipment->to_city_id }}">
			</select>
			<div class="invalid-feedback">
