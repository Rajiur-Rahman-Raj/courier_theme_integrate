		...
		<section class="section">
			<div class="section-header">
				...
				<div class="section-header-breadcrumb">
					...
					<div class="breadcrumb-item">@lang('Drivers')</div>
				</div>
			</div>
							...
							<div class="row justify-content-md-center">
								<div class="col-lg-12">
									<div class="card mb-4 card-primary shadow">
										<div
											class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
											<h6 class="m-0 font-weight-bold text-primary">@lang('Driver List')</h6>
														...
														<tr>
															<td colspan="100%" class="text-center p-2">
																<img class="not-found-img"
																	 ...
																	 alt="">
																<p class="text-center no-data-found-text">@lang('No Branch Driver Found')</p>
															</td>
														</tr>
													@endforelse
													</tbody>
