	...
	<div class="main-content">
		<section class="section">
			<div class="section-header">
				<h1>@lang("Create Employee")</h1>
				<div class="section-header-breadcrumb">
					<div class="breadcrumb-item active"><a href="{{ route('admin.home') }}">@lang("Dashboard")</a></div>
					<div class="breadcrumb-item"><a
							href="{{route('branchEmployeeList')}}">@lang("Employees")</a></div>
					<div class="breadcrumb-item">@lang("Create Employee")</div>
				</div>
			</div>
		</section>
							...
							<form method="post" action="{{ route('branchEmployeeStore') }}"
								...
								<div class="row">
									<div class="col-sm-12 col-md-3">
										<div class="mb-4">
											<label class="col-form-label">@lang("Employee Photo") <span class="font-weight-bold"><sub>(@lang('optional'))</sub></span></label>
