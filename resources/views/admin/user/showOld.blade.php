								...
								<div class="card-body">
									<form method="post" action="{{ route('user.edit',$user) }}"
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label for="email">@lang('E-Mail') <span class="text-danger">*</span></label>
											...
											<div class="col-sm-12 col-md-6">
												<div class="form-group">
													...
													<div class="invalid-feedback">@error('national_id') @lang($message) @enderror</div>
												</div>
											</div>
											...
											<div class="col-sm-12 col-md-12 mb-3">
												...
												<select name="branch_id"
													...
													@foreach($allBranches as $branch)
														<option value="{{ $branch->id }}" {{ $branch->id == $userProfile->branch_id ? 'selected' : '' }}>@lang($branch->branch_name)</option>
													@endforeach
												</select>
											...
											<div class="col-sm-12 col-md-6 mb-3">
												...
												<select name="country_id" class="form-control @error('country_id') is-invalid @enderror selectedCountry select2">
													...
													@foreach($allCountries as $country)
														<option value="{{ $country->id }}" {{ $country->id == $userProfile->country_id ? 'selected' : '' }}>@lang($country->name)</option>
													@endforeach
												</select>
											...
											<div class="col-sm-12 col-md-6 mb-3">
												...
												<select name="state_id" class="form-control @error('state_id') is-invalid @enderror selectedState select2">
													...
													@foreach($allStates as $state)
														<option value="{{ $state->id }}" {{ $state->id == $userProfile->state_id ? 'selected' : '' }}>@lang($state->name)</option>
													@endforeach
												</select>
											...
											<div class="col-sm-12 col-md-6 mb-3">
												...
												<select name="city_id" class="form-control @error('city_id') is-invalid @enderror selectedCity select2">
													...
													@foreach($allCities as $city)
														<option value="{{ $city->id }}" {{ $city->id == $userProfile->city_id ? 'selected' : '' }}>@lang($city->name)</option>
													@endforeach
												</select>
											...
											<div class="col-sm-12 col-md-6 mb-3">
												...
												<select name="area_id" class="form-control @error('area_id') is-invalid @enderror selectedArea select2">
													...
													@foreach($allAreas as $area)
														<option value="{{ $area->id }}" {{ $area->id == $userProfile->area_id ? 'selected' : '' }}>@lang($area->name)</option>
													@endforeach
												</select>
											...
											<div class="col-sm-12 col-md-6 mb-3">
												...
												<select name="client_type" class="form-control @error('client_type') is-invalid @enderror select2">
													<option value="0" {{ $user->user_type == 0 ? 'selected' : '' }}>@lang('Normal')</option>
													<option value="1" {{ $user->user_type == 1 ? 'selected' : '' }}>@lang('Sender/Customer')</option>
													<option value="2" {{ $user->user_type == 2 ? 'selected' : '' }}>@lang('Receiver')</option>
												</select>
