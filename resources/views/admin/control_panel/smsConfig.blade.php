					...
					<div class="col-12 col-md-8 col-lg-9">
										...
										<div class="card-body">
											<form action="{{ route('sms.config') }}" method="post">
												...
												<div class="row">
														...
														<div class="form-group">
															...
															<div class="selectgroup w-100">
																<label class="selectgroup-item">
																	<input type="radio" name="sms_notification"
																		   value="0"
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<div class="selectgroup w-100">
																<label class="selectgroup-item">
																	<input type="radio" name="sms_verification"
																		   value="0"
												...
												<ul class="nav nav-tabs" id="myTab" role="tablist">
													<li class="nav-item">
														<a class="nav-link {{ ($headerActive) ? 'active' : '' }}"
														   id="headerData-tab"
														   data-toggle="tab" href="#headerData" role="tab"
														   aria-controls="headerData"
														   aria-selected="{{ ($headerActive) ? 'true' : 'false' }}">@lang('Headers')</a>
													</li>
													<li class="nav-item">
														<a class="nav-link {{ ($paramActive) ? 'active' : '' }}"
														   id="params-tab"
														   data-toggle="tab" href="#params" role="tab"
														   aria-controls="params"
														   aria-selected="{{ ($paramActive) ? 'true' : 'false' }}">@lang('Params')</a>
													</li>
													<li class="nav-item">
														<a class="nav-link {{ ($formActive) ? 'active' : '' }}"
														   id="formData-tab"
														   data-toggle="tab" href="#formData" role="tab"
												...
												<div class="tab-content" id="myTabContent">
													<div
														class="tab-pane fade {{ ($headerActive) ? 'show active' : '' }}"
														id="headerData"
														...
														<div class="headerDataWrapper">
															@if(is_null($headerData))
																<div class="row">
																	<div class="col-md-4">
																		<div class="form-group">
																			<input type="text" name="headerDataKeys[]"
																				   value=""
													...
													<div class="tab-pane fade {{ ($paramActive) ? 'show active' : '' }}"
														 id="params"
														...
														<div class="paramsWrapper">
															@if(is_null($paramData))
																<div class="row">
																	<div class="col-md-4">
																		<div class="form-group">
																			<input type="text" name="paramKeys[]"
																				   value=""
																				   placeholder="@lang('Key')"
																				   class="form-control form-control-sm">
																		</div>
																	...
																	<div class="col-md-7">
																		<div class="form-group">
																			<input type="text" name="paramValues[]"
																				   value=""
																				   placeholder="@lang('Value')"
																				   class="form-control form-control-sm">
																		</div>
													...
													<div class="tab-pane fade{{ ($formActive) ? 'show active' : '' }}"
														 id="formData"
														...
														<div class="formDataWrapper">
															@if(is_null($formData))
																<div class="row">
																	<div class="col-md-4">
																		<div class="form-group">
																			<input type="text" name="formDataKeys[]"
																				   value=""
																				   placeholder="@lang('Key')"
																				   class="form-control form-control-sm">
																		</div>
						...
						<div class="paramHtml d-none">
							<div class="row">
								...
								<div class="col-md-1">
									<div class="form-group">
										<a href="javascript:void(0)" class="btn btn-danger btn-sm removeDiv"><i
												class="fas fa-minus"></i></a>
									</div>
								</div>
							</div>
