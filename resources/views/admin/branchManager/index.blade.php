...
@section('page_title', __('Managers'))
@push('extra_styles')
		...
		<section class="section">
			<div class="section-header">
				...
				<div class="section-header-breadcrumb">
					...
					<div class="breadcrumb-item">@lang('Managers')</div>
				</div>
			</div>
												...
												<div class="row">
													<div class="col-md-2">
														<div class="form-group">
															<input placeholder="@lang('Manager')" name="manager"
																   value="{{ old('manager',request()->manager) }}"
																   type="text"
							...
							<div class="row justify-content-md-center">
								<div class="col-lg-12">
									<div class="card mb-4 card-primary shadow">
										<div
											class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
											<h6 class="m-0 font-weight-bold text-primary">@lang('Manager List')</h6>
											@if(adminAccessRoute(config('permissionList.Manage_Branch.Branch_Manager.permission.add')))
												<a href="{{route('createBranchManager')}}"
												   class="btn btn-sm btn-outline-primary add"><i
														class="fas fa-plus-circle"></i> @lang('Create Manager')
												</a>
											@endif
										</div>
										<div class="card-body">
											<div class="table-responsive">
												<table
													...
													<tbody>
													@forelse($allBranchManagers as $key => $manager)
														<tr>
																...
																<a href="javascript:void(0)"
																   class="text-decoration-none">
																	<div
																		...
																		<div class="mr-3"><img
																				src="{{getFile($manager->driver,$manager->image) }}"
																				alt="user" class="rounded-circle"
																				width="40" height="40"
																				data-toggle="tooltip"
																				title=""
																				data-original-title="{{ __(optional($manager->admin)->name) }}">
																		</div>

																		<div
																			class="d-inline-flex d-lg-block align-items-center ms-2">
																			<p class="text-dark mb-0 font-16 font-weight-medium">
																				{{ __(optional($manager->admin)->name) }}</p>
																			<span
																				class="text-dark font-weight-bold font-14 ml-1">{{$manager->email}}</span>
																		</div>
																	</div>
																</a>
															</td>
																...
																<a href="javascript:void(0)"
																   class="text-decoration-none">
																	<div
																		class="d-lg-flex d-block align-items-center branch-list-img">
																		<div class="mr-3"><img
																				src="{{getFile(optional($manager->branch)->driver,optional($manager->branch)->image) }}"
																				alt="user" class="rounded-circle"
																				width="40" height="40"
																				data-toggle="tooltip"
																				title=""
																				data-original-title="{{ __(optional($manager->branch)->branch_name) }}">
																		</div>

																		<div
																			class="d-inline-flex d-lg-block align-items-center ms-2">
																			<p class="text-dark mb-0 font-16 font-weight-medium">
																				{{ __(optional($manager->branch)->branch_name) }}</p>
																			<span
																				class="text-dark font-weight-bold font-14 ml-1">{{optional($manager->branch)->email}}</span>
																		</div>
																	</div>
																</a>
															</td>
																...
																<td data-label="@lang('Action')">
																	...
																	@if(adminAccessRoute(config('permissionList.Manage_Branch.Branch_Manager.permission.login_as')))
																		<button
																				...
																				data-toggle="tooltip"
																				data-placement="top"
																				title="@lang('Login As Manager')"
																				class="btn btn-sm btn-outline-success loginUser rounded-circle">
														...
														<tr>
															<td colspan="100%" class="text-center">
																<img class="not-found-img"
																	 ...
																	 alt="">
																<p class="text-center d-block no-data-found-text">@lang('No Branch Manager Found')</p>
